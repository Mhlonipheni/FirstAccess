...
var LayoutModule = (function () {
    ...
    LayoutModule = __decorate([
        core_1.NgModule({
            imports: [common_1.CommonModule, ng2_bootstrap_1.TooltipModule, layout_routes_1.ROUTES, forms_1.FormsModule],
            declarations: [layout_component_1.Layout, sidebar_component_1.Sidebar, navbar_component_1.Navbar, chat_sidebar_component_1.ChatSidebar, search_pipe_1.SearchPipe, notifications_component_1.Notifications, notifications_load_directive_1.NotificationLoad, chat_message_component_1.ChatMessage]
        }), 
